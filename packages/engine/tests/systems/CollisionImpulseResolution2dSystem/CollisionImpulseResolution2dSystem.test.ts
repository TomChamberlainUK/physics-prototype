...
import { CollisionImpulseResolution2dSystem } from '#/systems/index.js';
import * as computeContactManifoldImpulseModule from '#/systems/CollisionImpulseResolution2dSystem/logic/computeContactManifoldImpulse.js';
